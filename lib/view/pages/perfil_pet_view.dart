...
class _PerfilPetViewState extends State<PerfilPetView> {
  late final PerfilPetController _controller;

  @override
  void initState() {
    super.initState();
    _controller = PerfilPetController(pet: widget.pet);
  }
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Galeria de Fotos
                if (_controller.galeriaFotos.isNotEmpty) ...[
                  SizedBox(
                    height: 80,
                    child: ListView.separated(
                      scrollDirection: Axis.horizontal,
                      itemCount: _controller.galeriaFotos.length,
                      separatorBuilder: (_, __) => const SizedBox(width: 8),
                      itemBuilder: (context, index) {
                        final item = _controller.galeriaFotos[index];
                        final isSelected =
                            _controller.fotoSelecionadaIndex == index;

                        return GestureDetector(
                          onTap: () => _controller.selecionarFoto(index),
                          child: Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: PetImageWidget(
                                fotoBase64: _controller.usaBase64 ? item : '',
                                fotoUrl: _controller.usaBase64 ? '' : item,
                                width: 80,
                                height: 80,
                              ),
                            ),
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: ElevatedButton(
                          onPressed: () => _controller.entrarEmContato(context),
